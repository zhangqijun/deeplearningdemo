...
$(function () {
    ...
    $(".swiper-container ul li").click(function () {
        ...
        $(".demo-container").children("ul").append("<li><img src=/static/static_img/lyf.jpg ></li>");
        $(".demo-container").children("ul").append("<li><img src=/static/static_img/cdl.png ></li>");
        $(".demo-container").children("ul").append("<li><img src=/static/static_img/hl.png ></li>");
        $(".demo-container").children("ul").append("<li><img src=/static/static_img/lj.png ></li>");
        $(".demo-container").children("ul").append("<li><img src=/static/static_img/lt.png ></li>");
        $(".demo-container").children("ul").append("<li><img src=/static/static_img/yamy.png ></li>");
        $(".demo-container").children("ul").append("<li><img src=/static/static_img/ymj.png ></li>");
        /*******************图片滑动***************************/
    ...
    $(document).on('click', '.demo-container ul li img', function () {
        ...
        var zhixing = true;
        $(".kptvalue").text("插值中：大约需要1分钟,请不要刷新,耐心等候");
        if (zhixing) {
            try {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status) {
                        ...
                        $(".infor_message").empty();
                        $(".infor_message").append("<img src = /" + data.name + " width='512' height='512'>");
