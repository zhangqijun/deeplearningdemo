        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.status) {
                    ...
                    $(".demo-container").children("ul").append("<li><img src=/static/tmpimg/" + data.name + "_maskrcnn.png ></li>");
                    $(".bboxesvalue").text(JSON.stringify(data.res.boxes));
                    $(".labelsvalue").text(JSON.stringify(data.res.labels));
                    $(".scoresvalue").text(JSON.stringify(data.res.scores));
                    $(".segmentvalue").text("     太长不写了");
