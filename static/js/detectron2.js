        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.status) {
                    ...
                    $(".demo-container").children("ul").append("<li><img src=/static/tmpimg/" + data.name + "_detectron2.png ></li>");
                    $(".bboxesvalue").text("      太长");
                    $(".labelsvalue").text(JSON.stringify(data.res.labels));
                    $(".areasvalue").text(JSON.stringify(data.res.areas));
                    $(".segmentvalue").text("     太长");
